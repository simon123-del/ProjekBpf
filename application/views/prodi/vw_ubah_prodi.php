                ...
                <input type="hidden" name="id" value="<?= $prodi['id']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jurusan" id="jurusan" value="<?= $prodi['jurusan']; ?>" class="form-control">
                            ...
                            <option value="JTI"
                                <?php if ($prodi['jurusan'] == "JTI") {
                                    echo "selected";
                                } ?>>JTI</option>
                            </option>
                            <option value="JTIN"
                                <?php if ($prodi['jurusan'] == "JTIN") {
                                    echo "selected";
                                } ?>>JTIN</option>
                            </option>
                            <option value="Akuntansi"
                                <?php if ($prodi['jurusan'] == "Akuntansi") {
                                    echo "selected";
                                } ?>>Akuntansi</option>
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="gambar" id="gambar" value="<?= $prodi['gambar']; ?>">
                            <label for="gambar" class="custom-file-label">Choose File</label>
                            <?= form_error('gambar', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    <a href="<?= base_url('Prodi') ?>" class="btn btn-danger">Tutup</a>
                    <button type="submit" name="ubah" class="btn btn-primary float-right">Edit Prodi</button>
                </form>
            </div>
        </div>
    </div>
