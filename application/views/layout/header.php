        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">BPF Project</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="<?= site_url('Dasboard/') ?>" class="menu-link">
            ...
            if($user['role'] == 'Admin') { ?>
            <li class="menu-item">
              <a href="<?= site_url('Pabrik/') ?>"   class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Pabrik">Pabrik</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="<?= site_url('Profil/') ?>"   class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Pabrik">Profil</div>
              </a>
            </li>
            
            <li class="menu-item">
              <a href="<?= site_url('Profil/pabrik') ?>"   class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Pabrik">Pabrik</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="<?= site_url('Auth/logout') ?>"   class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Pabrik">Logout</div>
              </a>
            </li>
              ...
              <li class="nav-item lh-1 me-3">
                ...
                <li class="nav-item lh-1 me-3">
                  <a href="<?= base_url('Profil/detail') ?>"> 
                    <?= $jlh ?> <i class="menu-icon tf-icons bx bx-cart"></i>
                  </a>
                </li>
                ...
                <?php
                  ...
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?= base_url('assets/img/profile/') . $user['gambar']; ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
